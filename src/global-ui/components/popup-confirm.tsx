...
import {deviceWidth, deviceHeight} from '../../utils/app-const';
import {FONT_FAMILY} from 'src/components/app-text/app-font';

type ICallback = (content?: string) => void;
const PopupConfirmUI = React.forwardRef<IPopupUI, {}>((props: any, ref) => {
  ...
  const cancelRef = React.useRef<ICallback | null>(null);
        ...
        <Animated.View
          ...
          <Animated.View
            ...
            <AppView height={getSize.v(44)} row>
              <TouchableOpacity style={styles.btnAction} onPress={handleCancel}>
                <AppText
